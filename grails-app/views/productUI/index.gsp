                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="price" title="price" params="${params}"/>
                    ...
                    <tbody>
                        <g:each in="${entityInstanceList}" status="i" var="entityInstance">
                            <tr>
                                ...
                                <td>${fieldValue(bean: entityInstance, field: "price")}</td>

                                <td>
                                    <div class="list-action">
                                        <sec:access url="/productUI/index/${entityInstance?.id}">
                                            <g:link action="edit" id="${entityInstance?.id}"><i class="fa fa-fw fa-edit"></i>Edit</g:link>
                                        </sec:access>
                                        <sec:access url="/productUI/edit/${entityInstance.id}">
