...
<html>
    ...
    <body>
        <a href="#list-userLocation" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="list-userLocation" class="content scaffold-list" role="main">
            <h1><g:message code="default.list.label" args="[entityName]" /></h1>
            <g:if test="${flash.message}">
                <div class="message" role="status">${flash.message}</div>
            </g:if>
            <!-- <f:table collection="${userLocationList}" /> -->
        ...
        %{--Customize List End--}%
            ...
            <div class="pagination">
                <g:paginate total="${userLocationCount ?: 0}" />
            </div>
        </div>
    </body>
</html>